...
import { createFloor, createCubes, createSphere, createDirectionalLight } from "./scene.js";
...
class Lesson08 extends LessonBase {
    ...
    setupLights() {
        ...
        const { light, helper } = createDirectionalLight(this.scene, { x: DEFAULT_VALUES.lightX, y: DEFAULT_VALUES.lightY, z: DEFAULT_VALUES.lightZ }, DEFAULT_VALUES.shadowQuality, DEFAULT_VALUES.shadowBias);
