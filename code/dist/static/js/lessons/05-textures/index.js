...
import { LessonBase, addLights, createOrbitControls, createCheckerTexture, createNoiseTexture, createGradientTexture, Logger, DOM } from "../../shared/index.js";
/**
...
class Lesson05 extends LessonBase {
    ...
    createTexturedCube(texture, position) {
    ...
    setupCubes() {
        ...
        this.cubes[3].material.color.set('#888888');
    }
    createLabels() {
        ...
        this.addEventListener(input, 'change', (e) => {
            ...
            reader.onload = (event) => {
                ...
                img.onload = () => {
                    ...
                    const material = this.cubes[3].material;
